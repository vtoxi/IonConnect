#ifndef ION_CONNECT_ESP32_H
#define ION_CONNECT_ESP32_H
...
/**
 * @brief ESP32 implementation of IonConnect
 */
class IonConnectESP32 : public IonConnectBase {
public:
    IonConnectESP32();
    virtual ~IonConnectESP32();
